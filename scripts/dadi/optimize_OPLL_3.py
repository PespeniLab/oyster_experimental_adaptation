...
#**************
snps = "/users/r/b/rbrennan/oyster/analysis/dadi/dadi.llop.in"
...
Optimize_Functions.Optimize_Routine(fs, pts, prefix, "anc_asym_mig", Models_2D.anc_asym_mig, rounds, 6, fs_folded=fs_folded, reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2, m12, m21, T1, T2",in_upper = upper, in_lower = lower)


upper = [20,20,20,20,20]
lower = [0.01,0.01,0.01,0.1,0.1]

# Split with no gene flow, followed by period of continuous symmetrical gene flow.
Optimize_Functions.Optimize_Routine(fs, pts, prefix, "sec_contact_sym_mig", Models_2D.sec_contact_sym_mig, rounds, 5, fs_folded=fs_folded, reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2, m, T1, T2",in_upper = upper, in_lower = lower)
